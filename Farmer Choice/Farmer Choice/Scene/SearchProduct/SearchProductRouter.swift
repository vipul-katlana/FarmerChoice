...
class SearchProductRouter: NSObject, SearchProductRoutingLogic, SearchProductDataPassing
{
  ...
  //func navigateToSomewhere(source: SearchProductViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: SearchProductDataStore, destination: inout SomewhereDataStore)
  //{
