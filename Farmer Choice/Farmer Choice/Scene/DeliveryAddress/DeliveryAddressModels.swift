...
enum DeliveryAddress {
    ...
    class ViewModel: WSResponseData {
        ...
        required init(from decoder: Decoder) throws {
            ...
            timeslot = try values.decodeIfPresent([Timeslot].self, forKey: .timeslot)
...
enum TimeSlot {
    ...
    class ViewModel: WSResponseData {
        ...
        required init(from decoder: Decoder) throws {
            ...
            next_days = try values.decodeIfPresent(Int.self, forKey: .next_days)
            timeslot = try values.decodeIfPresent([Timeslot].self, forKey: .timeslot)
            data = try values.decodeIfPresent(String.self, forKey: .data)
            time_slot_msg = try values.decodeIfPresent(String.self, forKey: .time_slot_msg)
            order_time_msg = try values.decodeIfPresent(String.self, forKey: .order_time_msg)
